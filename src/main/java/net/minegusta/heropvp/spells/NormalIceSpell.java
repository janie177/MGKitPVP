...
public class NormalIceSpell extends MovingParticleWithAction {

	private String casterUUID;
	public NormalIceSpell(int duration, Effect effect, Location location, double blocksPerSecond, Location target, boolean blocks, Player caster) {
	...
	@Override
	public void onHit() {
		location.getWorld().spigot().playEffect(location, Effect.SNOWBALL_BREAK, 0, 0, 1, 1, 1, 1, 30, 50);
		location.getWorld().spigot().playEffect(location, Effect.SNOW_SHOVEL, 0, 0, 1, 1, 1, 1, 30, 50);
